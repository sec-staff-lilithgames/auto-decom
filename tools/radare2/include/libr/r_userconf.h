...
#define R2_BINDIR "/usr/local/bin"
#define R2_MANDIR "/usr/local/share/man"
#define R2_INCDIR "/usr/local/include"
...
#define R2_FORTUNES R_JOIN_3_PATHS ("/usr/local/share", "doc", "radare2")
